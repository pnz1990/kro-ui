...
/**
 * NODE_CONCEPT_TEXT — human-readable concept explanation per upstream kro node type.
 *
 * Defined once here alongside NODE_TYPE_LABEL so NodeDetailPanel and
 * LiveNodeDetailPanel share a single source of truth. Never copy-paste this map.
 * Constitution §IX: shared rendering helpers must live in @/lib/, not components.
 *
 * Terminology conventions:
 *   Short form (badge, pill, tooltip): use NODE_TYPE_LABEL values
 *     ("Root CR", "External Ref", "External Ref Collection")
 *   Long form (concept panel descriptions): spell out in full
 *     ("Root Custom Resource", "External Reference", "External Reference Collection")
 */
export const NODE_CONCEPT_TEXT: Record<NodeType, string> = {
  instance:

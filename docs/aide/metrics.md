...
| 2026-04-22 | reconstructed-3 | 14 | - | - | - | 14 | -2 | 5 | reconstructed by vibe-vision-auto scan 3; PRs #703–#726; feat: anchor journeys 085 (air-gapped, issue #676), 086 (degraded-cluster, issue #674), 087 (RBAC-restricted, issue #675); fix: ts pin, workflow regex; skills_count from ls ~/.otherness/agents/skills/*.md=14 (prior row overstated 16); item 27.55 |

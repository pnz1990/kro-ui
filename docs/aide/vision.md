...
| ~~`docs/aide/product-changelog.md` does not exist — product advancement invisible~~ ✅ shipped (PR #796) | doc 28 §28.4 | `product-changelog.md` now exists: 10-row rolling table of most recently shipped user-visible features; SM updates after each batch; addresses the "is the product getting better?" question in one view |

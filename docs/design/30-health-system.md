...
- 🔲 Designer axe-core coverage (owned here from doc 31): the `/author` Designer page is excluded from journey 074 axe-core scan despite being the most interactive page in kro-ui; add axe-core assertions for the Designer in the accessibility journey (GH #683)
